...
export const brands: Brand[] = [
  ...
  { name: "ChocolateLady Doll", category: "known", url: "https://www.chocolateladydoll.com/", icon: icon("chocolatelady-doll.png") },
  ...
  { name: "Starry Doll", category: "known", icon: icon("starry-doll.png"), features: ["fantasy"], note: "Информация доступна через дилеров" },
  ...
  { name: "AIOMI", category: "additional", icon: icon("aiomi.png"), note: "Информация доступна через дилеров" },
  ...
  { name: "HOUYU Doll", category: "additional", icon: icon("houyu-doll.png"), note: "Информация доступна через дилеров" },
  ...
  { name: "KuLove Doll", category: "additional", url: "https://kulovedoll.com/", icon: icon("kulove-doll.png") },
  ...
  { name: "NOT YE", category: "additional", url: "https://not-ye.com/", icon: icon("not-ye.png") },
  ...
  { name: "SINEEM Doll", category: "additional", url: "https://sineemdoll.com/", icon: icon("sineem-doll.png") },
  ...
  { name: "NIANTA / Torso X", aliases: ["NIANTA", "Torso X"], category: "torsos", url: "https://niantastore.com/collections/nianta-torso-x-sex-dolls-compact-realistic-torso", icon: icon("nianta-torso-x.png"), features: ["torsos"] },
