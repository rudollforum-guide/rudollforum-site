...
const steps = [
  {
    icon: "♙", title: "Создание учётной записи",
  ...
  {
    icon: "⌕", title: "Проверка модели и комплектации",
  ...
  {
    icon: "✉", title: "Уточнение деталей у менеджера",
  ...
  {
    icon: "▣", title: "Корзина, язык и валюта",
  ...
  {
    icon: "◇", title: "Промокод Rudollforum",
  ...
  {
    icon: "↺", title: "Изменение или отмена заказа",
  ...
  {
    icon: "⚙", title: "Производство и заводские фотографии",
  ...
  {
    icon: "!", title: "Товары с заявленными дефектами",
    ...
    <article className="article moon-guide">
      ...
      <div className="moon-timeline">
        {steps.map((step,index)=><section className="moon-step" key={step.title}>
          <div className="moon-step-marker"><span>{String(index+1).padStart(2,"0")}</span><i aria-hidden="true">{step.icon}</i></div>
