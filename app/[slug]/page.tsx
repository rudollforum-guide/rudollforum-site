...
function UsefulLinksActions() {
  return <div className="resource-featured-links useful-featured-pair">
    <FeaturedExternalLink href="https://www.moon-doll.com/" variant="moon" icon="☾" title="Открыть Moon-Doll" subtitle="внешний международный магазин" rel="noopener noreferrer sponsored"/>
    <FeaturedInternalLink href="/shops/moon-doll-guide" icon="▤" title="Инструкция по заказу" description="пошаговое руководство Rudollforum"/>
  </div>;
}
