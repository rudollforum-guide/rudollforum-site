...
export function SiteShell({children}:{children:React.ReactNode}) {
  return <><SiteEffects/><header className="site-header"><div className="topline">18+ · Информационный ресурс для совершеннолетней аудитории</div><div className="header-inner"><Link href="/" className="brand" aria-label="Rudollforum — на главную"><img className="brand-mark" src={publicPath("/images/header/rudollforum-header-emblem.png")} alt="" aria-hidden="true" width="56" height="56"/><span className="brand-copy"><span className="brand-title"><strong>Rudollforum</strong><em className="header-age">18+</em></span><span className="brand-subtitle">TPE и силиконовые куклы</span><small>Независимый справочник по выбору, покупке, уходу и хранению</small></span></Link><SiteNavigation/></div></header><main>{children}</main><footer><div className="footer-ornament" aria-hidden="true">✦　◇　✦</div><div className="footer-grid"><div><div className="footer-brand"><img className="footer-brand-mark" src={publicPath("/images/footer/rudollforum-footer-mark.png")} alt="" aria-hidden="true" width="44" height="44"/><span>Rudollforum</span></div><p>Независимый справочник по выбору, покупке, уходу и хранению силиконовых и ТПЕ-кукол.</p><span className="age-mark">18+ · Информационный ресурс</span><p className="footer-disclaimer">Rudollforum является независимым информационным справочником и сообществом владельцев силиконовых и ТПЕ-кукол. Сайт не принимает оплату и не оформляет заказы.</p></div><div><strong>Основное</strong><Link href="/guide">Практическое руководство</Link><FeaturedExternalLink href={publicPath("/documents/rudollforum-guide-tpe-silicone-2026.pdf")} variant="pdf" iconImage={publicPath("/images/footer/guide-icon.png")} title="Руководство PDF" subtitle="полная версия"/><Link href="/where-to-buy">Где купить</Link><Link href="/owner-reviews">Отзывы владельцев</Link><Link href="/safe-purchase">Безопасная покупка</Link><Link href="/shops/moon-doll-guide">Заказ на Moon-Doll</Link></div><div><strong>Эксплуатация</strong><Link href="/care">Уход</Link><Link href="/storage">Хранение</Link><Link href="/repair">Ремонт</Link></div><div><strong>О проекте</strong><Link href="/community">О сообществе</Link><Link href="/events">Мероприятия</Link><Link href="/editorial-policy">Редакционная политика</Link><Link href="/age-policy">Возрастные ограничения</Link><Link href="/useful-links">Полезные ссылки</Link><FeaturedExternalLink href="https://t.me/rudollforum" variant="telegram" iconImage={publicPath("/images/footer/telegram-icon.png")} title="Telegram" subtitle="сообщество владельцев"/><FeaturedExternalLink href="https://www.moon-doll.com/" variant="moon" iconImage={publicPath("/images/footer/moon-doll-icon.png")} title="Moon-Doll" subtitle="внешний магазин" rel="noopener noreferrer sponsored"/></div></div><div className="copyright"><span>18+. Сайт предназначен только для совершеннолетней аудитории.</span><span>© 2026 Rudollforum · Сайт не продаёт товары и не принимает оплату.</span></div></footer></>
}
